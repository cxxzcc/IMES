...
public class ResponseData<T> {
    ...
    public static <T> ResponseData<T> success(T data, String msg) {
        return new ResponseData<T>(ResultResponseEnum.WEAK_SUCCESS.getCode(), msg, data);
    }
     ...
     * @return 结果集
     */
    public static <T> ResponseData<T> success(String code, String msg, T data) {
    ...
    public Boolean isSuccess() {
        return StrUtil.equals(ResultResponseEnum.SUCCESS.getCode(), code);
    }
}
