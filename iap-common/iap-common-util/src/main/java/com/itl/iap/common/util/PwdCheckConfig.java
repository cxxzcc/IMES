...
public class PwdCheckConfig {
     ...
     * 常用词库
     */
    public static String[] SIMPLE_WORDS = {"admin", "password", "dare", "root", "guest", "user",
            "success", "pussy", "mustang", "jordan", "test", "hunter", "jennifer", "batman",
            "thomas", "soccer", "sexy", "killer", "george", "asshole", "summer", "hello", "secret", "fucker",
            "enter", "cookie", "administrator", "123456", "monkey", "dragon", "baseball", "master", "sunshine",
            "ashley", "bailey", "shadow", "superman", "football", "michael"};
