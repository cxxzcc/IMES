...
public class MsgSendRecordController {
    ...
    public ResponseData<IPage<Map<String, Object>>> getMessageByUserName(@RequestParam(value = "noticeType", required = false) Integer noticeType,
                                                                         @RequestParam("page") Integer page, @RequestParam("pageSize") Integer pageSize,
                                                                         @RequestParam(value = "searchText", required = false) String searchText) {
        return ResponseData.success(msgSendRecordService.getMessageByUserName(UserUtils.getUserId(), noticeType, page, pageSize, searchText));
    }
    ...
    public ResponseData<Integer> getUnread() {
        ...
        return ResponseData.success(msgSendRecordService.getUnread(user.getId()));
    }
