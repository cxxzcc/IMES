...
public class NoticeServiceImpl implements NoticeService, ApplicationContextAware {
    ...
    @Override
    public Integer getUnreadCountByUser(String userId) {
        return msgSendRecordService.getUnread(userId);
    }

    @Override
    public Map<String, Object> getUnreadCountGroupByType(String userId) {
        return msgSendRecordService.getUnreadCountGroupByType(userId);
    }
}
