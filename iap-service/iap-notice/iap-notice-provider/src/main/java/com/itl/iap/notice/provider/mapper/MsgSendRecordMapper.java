...
public interface MsgSendRecordMapper extends BaseMapper<MsgSendRecord> {
     ...
     */
    IPage<Map<String, Object>> findListByUsername(Page page, @Param("userId") String userId, @Param("userName") String userName,@Param("noticeType") Integer noticeType, @Param("searchText") String searchText);
//    IPage<MsgSendRecordDto> pageQuery(Page page, @Param("msgSendRecordDto") MsgSendRecordDto msgSendRecordDto);
     ...
     * @param userId 用户id
     * */
    List<Map<String, Object>> getUnreadCountGroupByType(@Param("userId") String userId);
}