...
public interface TypeService extends IService<Type> {
     ...
     * @throws CommonException
     */
    int delete(String[] types) throws CommonException;
     ...
     * @throws CommonException
     */
    IPage<Type> queryPage(Map<String, Object> params) throws CommonException;
     ...
     * @throws CommonException
     */
    IPage<Type> queryPageForUse(Map<String, Object> params) throws CommonException;
}
