...
public class TypeController {
    ...
    public ResponseData<String> delete(@RequestBody String[] types) throws CommonException {
        typeService.delete(types);
    ...
    public ResponseData<IPage<Type>> page(@RequestBody Map<String, Object> params) throws CommonException {
        params.put("orderByField", "CREATE_DATE");
        params.put("isAsc", false);
        return ResponseData.success(typeService.queryPage(params));
    }
    ...
    public ResponseData<IPage<Type>> pageForUse(@RequestBody Map<String, Object> params) throws CommonException {
        params.put("orderByField", "CREATE_DATE");
        params.put("isAsc", false);
        return ResponseData.success(typeService.queryPageForUse(params));
    }
}
