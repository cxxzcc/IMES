...
public class TypeServiceImpl extends ServiceImpl<TypeMapper, Type> implements TypeService {
    ...
    public void saveByTypeVo(TypeVo typeVo) throws CommonException {
        ...
        if (type_db == null) {
            ...
            int updateInt = typeMapper.updateById(type);
            if (updateInt == 0) {
    ...
    public TypeVo getTypeVoByType(String andonType) throws CommonException {
        ...
        if (type_db.getAndonPushBo() != null && !"".equals(type_db.getAndonPushBo())) {
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, RuntimeException.class})
    public int delete(String[] types) throws CommonException {
        List<String> bos = new ArrayList<>();
        String site = UserUtils.getSite();
        Arrays.asList(types).forEach(type -> bos.add(new TypeHandleBO(site, type).getBo()));
        int deleteInt = 0;
        try {
    ...
    @Override
    public IPage<Type> queryPage(Map<String, Object> params) throws CommonException {
        QueryWrapper<Type> query = new QueryWrapper<>();
        query.eq(Type.SITE, UserUtils.getSite());
    ...
    @Override
    public IPage<Type> queryPageForUse(Map<String, Object> params) throws CommonException {
        QueryWrapper<Type> query = new QueryWrapper<>();
        query.lambda()
                .eq(Type::getState, "1")
...
//        });
        ...
        return page(new QueryPage<>(params), query);
    }
