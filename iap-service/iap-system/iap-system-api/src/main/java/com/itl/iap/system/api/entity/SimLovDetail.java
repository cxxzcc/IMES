...
public class SimLovDetail extends BaseModel {
     ...
     * 内层Lov版本
     */
    @TableField("inner_lov_version")
    private String innerLovVersion;

    /**
     * 内层Lov编码
     */
    @TableField("inner_lov_code")
    private String innerLovCode;

    /**
     * 内层Lov返回字段
     */
    @TableField("inner_lov_prop")
    private String innerLovProp;

    /**
     * 外层Lov展示字段
     */
    @TableField("outer_lov_show_prop")
    private String outerLovShowProp;
}
