...
public interface IapSysUserTService extends IService<IapSysUserT> {
     ...
     * 根据用户id用户密码
     *
     * @param changePwdDto 更改密码dto
     * @return Integer
     */
    Integer updateUserPwdById(ChangePwdDto changePwdDto) throws CommonException;
    ...
    IapSysUserT getUser(String userName);

    List<IapSysUserT> getUserList(List<String> userNameList);
     ...
     * @return
     */
    List<IapSysUserT> queryUserByUserName(String userName);
}
