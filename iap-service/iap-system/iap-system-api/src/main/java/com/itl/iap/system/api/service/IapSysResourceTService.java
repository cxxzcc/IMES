...
public interface IapSysResourceTService extends IService<IapSysResourceT> {
     ...
     */
    List<IapSysResourceTDto> queryList(String clientType);
     ...
     * @return List<IapSysResourceTDto>
     */
    List<IapSysResourceTDto> getAllMenu(String clientType);

    List<IapSysResourceTDto> getAllMenuTwo(String clientType);
}
