...
public class IapSysPositionTController {
    ...
    public ResponseData<IPage<List<Map<String, Object>>>> getUserListByPositionId(@RequestBody Map<String, Object> map) {
        return ResponseData.success(iapPositionService.queryUserListByPositionId(map));
    }
