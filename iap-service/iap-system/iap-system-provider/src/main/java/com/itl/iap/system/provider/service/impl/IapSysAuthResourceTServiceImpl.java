...
public class IapSysAuthResourceTServiceImpl extends ServiceImpl<IapSysAuthResourceTMapper, IapSysAuthResourceT> implements IapSysAuthResourceTService {
    ...
    public boolean saveAuthResource(List<IapSysAuthResourceT> authResourceTs, String authId, String clientType) {
        List<IapSysAuthResourceT> having = iapSysAuthResourceMapper.selectSource(authId, clientType);
    ...
    @Override
    public List<IapSysAuthResourceT> selectSource(String authId, String clientType) {
        return iapSysAuthResourceMapper.selectSource(authId, clientType);
    }
}
