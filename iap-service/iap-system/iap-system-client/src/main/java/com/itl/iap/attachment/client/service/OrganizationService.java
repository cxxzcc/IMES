...
public interface OrganizationService {
    ...
    @PostMapping("/organization/getByIds")
    @ApiOperation(value = "根据id集合获取name集合", notes = "根据id集合获取name集合")
    List<Map<String, String>> getByIds(@RequestBody Set<String> ids);

    @GetMapping("/organization/getIdByCode")
    @ApiOperation(value = "根据id集合获取name集合", notes = "根据id集合获取name集合")
    String getIdByCode(@RequestParam String code);
