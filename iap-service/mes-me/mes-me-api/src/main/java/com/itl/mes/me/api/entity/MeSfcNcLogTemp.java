 ...
 */
@Data
@TableName("me_sfc_nc_log_temp")
@ApiModel(value = "me_sfc_nc_log_temp", description = "comments")
@Accessors(chain = true)
public class MeSfcNcLogTemp implements Serializable {
	 ...
	 */
	@TableId
	@ApiModelProperty(value = "唯一标识【PK】-n")
	private String bo;
	/**
	 * 工厂
	 */
	@ApiModelProperty(value = "工厂-n")
	private String site;
	/**
	 * SN【FK】
	 */
	 ...
	 * SFC过程
	 */
	@ApiModelProperty(value = "SFC过程-n")
