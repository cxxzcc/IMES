...
public class ClassFrequencyServiceImpl implements ClassFrequencyService {
    ...
    @Override
    public IPage<ClassSystemFrequencyMergeDTO> findMergeList(ClassSystemFrequencyMergeDTO classSystemFrequencyMergeDTO) {

        if(ObjectUtil.isEmpty(classSystemFrequencyMergeDTO.getPage())){
            classSystemFrequencyMergeDTO.setPage(new Page(0, 10));
        }
        return classFrequencyMapper.findMergeList(classSystemFrequencyMergeDTO.getPage(), classSystemFrequencyMergeDTO);
    }
