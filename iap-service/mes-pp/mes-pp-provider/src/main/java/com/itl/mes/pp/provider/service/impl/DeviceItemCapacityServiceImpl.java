...
public class DeviceItemCapacityServiceImpl
    ...
    public void saveMachineProductCapacityEntity(
        ...
        deviceItemCapacityEntity.setItemBo(new ItemHandleBO(UserUtils.getSite(), deviceItemCapacityEntity.getItemBo(), deviceItemCapacityEntity.getItemVersion()).getBo());
        if (StringUtils.isNotEmpty(deviceItemCapacityEntity.getProductLineBo())) {
            deviceItemCapacityEntity.setProductLineBo(new ProductLineHandleBO(UserUtils.getSite(), deviceItemCapacityEntity.getProductLineBo()).getBo());
        }
        ...
        if (StringUtils.isNotEmpty(deviceItemCapacityEntity.getDeviceBo())) {
            deviceItemCapacityEntity.setDeviceBo(new DeviceHandleBO(UserUtils.getSite(), deviceItemCapacityEntity.getDeviceBo()).getBo());
        }
        deviceItemCapacityEntity.setBom(new BomHandleBO(UserUtils.getSite(), deviceItemCapacityEntity.getBom(), deviceItemCapacityEntity.getVersion()).getBo());
