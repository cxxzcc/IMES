...
public class ResourcesCalendarServiceImpl implements ResourcesCalendarService {
    ...
    public void update(ResourcesCalendarEntity resourcesCalendarEntity) {
        resourcesCalendarEntity.setDeviceBo(null);
        resourcesCalendarEntity.setProductLineBo(null);
        resourcesCalendarEntity.setUserBo(null);
    ...
    public void occupyResourcesCalendar(List<Map<String, Object>> maps) {
        ...
        maps.forEach(map -> {
            ...
            if (databaseId.equals(CommonUtil.DATABASEID)) {
                resourcesCalendarMapper.updateResourcesCalendar(resourcesCalendarEntity, mapStartDateStr, mapEndDateStr);
            } else {
            ...
            List<CapacityLoadEntity> capacityLoadEntities;
            if (databaseId.equals(CommonUtil.DATABASEID)) {
                capacityLoadEntities = capacityLoadMapper.capacityLoadEntities((String) map.get("productLineBo"), mapStartDateStr,mapEndDateStr);
            } else {
                capacityLoadEntities = capacityLoadMapper.selectList(queryWrapper);
            }
            ...
            List<ResourcesCalendarEntity> resourcesCalendarEntities= databaseId.equals(CommonUtil.DATABASEID)?resourcesCalendarMapper.getResourcesCalendarEntity((String)map.get("productLineBo"),mapStartDateStr,mapStartDateStr):resourcesCalendarMapper.selectList(wrapper);
