...
import com.itl.mes.pp.api.dto.schedule.ScheduleProductionLineQueryTwoDTO;
import com.itl.mes.pp.api.dto.schedule.ScheduleProductionLineRespDTO;
import com.itl.mes.pp.api.dto.schedule.ScheduleProductionLineSaveTwoDTO;
...
public interface ScheduleProductionLineMapper extends BaseMapper<ScheduleProductionLineEntity> {
    ...
    List<ScheduleProductionLineSaveTwoDTO> findTwoList(ScheduleProductionLineQueryTwoDTO scheduleProductionLineQueryTwoDTO);

    ScheduleProductionLineSaveTwoDTO findTwoById(String bo);
