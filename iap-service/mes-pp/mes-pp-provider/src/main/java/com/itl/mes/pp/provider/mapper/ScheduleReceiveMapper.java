...
public interface ScheduleReceiveMapper extends BaseMapper<ScheduleReceiveEntity> {
    ...
    IPage<ReceiveRespDTO> receiveList(Page page, @Param("scheduleReceive") ScheduleReceiveQueryDTO scheduleReceiveQueryDTO , @Param("site") String site);


    IPage<ScheduleReceiveRespDTO> scheduleReceiveList(Page page, @Param("scheduleReceive") ScheduleReceiveQueryDTO scheduleReceiveQueryDTO, @Param("site") String site);
}
