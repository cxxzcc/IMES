...
public interface ResourcesCalendarMapper extends BaseMapper<ResourcesCalendarEntity> {
    ...
    int updateResourcesCalendar(@Param("rce")ResourcesCalendarEntity resourcesCalendarEntity,@Param("ms")String mapStartDateStr,@Param("me")String mapEndDateStr);

    List<ResourcesCalendarEntity> getResourcesCalendarEntity(@Param("rce") String productLineBo, @Param("ms")String mapStartDateStr,@Param("me") String mapStartDateStr1);
}
