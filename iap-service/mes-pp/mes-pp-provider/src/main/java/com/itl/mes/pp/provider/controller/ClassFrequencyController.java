...
public class ClassFrequencyController {
    ...
    @ApiOperation(value = "分页查询组合信息", notes = "分页查询组合信息")
    public ResponseData findMergeList(@RequestBody ClassSystemFrequencyMergeDTO classSystemFrequencyMergeDTO) {
        return ResponseData.success(classFrequencyService.findMergeList(classSystemFrequencyMergeDTO));
    }
    ...
    public ResponseData<ClassFrequencyEntity> getById(@PathVariable String id) {
