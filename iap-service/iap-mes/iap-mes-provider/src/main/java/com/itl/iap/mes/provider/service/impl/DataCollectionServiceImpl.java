...
public class DataCollectionServiceImpl {
    ...
    public List<DataCollection> findByIds(List<String> dataCollectionIds) {
        if(CollUtil.isEmpty(dataCollectionIds)) {
            return Collections.emptyList();
        }
        return dataCollectionMapper.selectBatchIds(dataCollectionIds);
