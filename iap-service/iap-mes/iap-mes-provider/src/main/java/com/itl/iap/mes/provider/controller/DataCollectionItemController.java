...
public class DataCollectionItemController extends BaseController {
    ...
    @ApiOperation(value = "getList", notes = "查看所有-生产执行", httpMethod = "GET")
    @GetMapping(value = "/getList/{operationId}")
    public ResponseData getList(@PathVariable String operationId) {
        return ResponseData.success(dataCollectionItemService.getList(operationId));
    }
