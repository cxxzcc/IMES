...
package com.itl.mom.label.provider.config;
...
public class Constant {
    ...
    public static final String LIST_DATA_SOURCE = "listDataSource";

    public static final String SUB_LIST_DATA_SOURCE = "subListDataSource";
    ...
    public static final Integer ARRAY_CODE= 6;

    public static final Integer SUB_DATA_SOURCE_CODE= 7;

    public static final Integer MAX_THREAD = 200;

    /**
     * 标识模板类型：代表标签用什么工具去画模板
     */
    public static final String JASPER = "JASPER";

    public static final String LODOP = "LODOP";
