...
public class StationServiceImpl implements StationService {
    ...
    @Override
    public ResponseData<Station> getStationById(String id) {
        log.error("sorry StationService getStationById feign fallback id:{}" + id);
        return ResponseData.error("getStationById查询失败");
    }
}
