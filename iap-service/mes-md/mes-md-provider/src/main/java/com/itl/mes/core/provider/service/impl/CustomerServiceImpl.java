...
public class CustomerServiceImpl extends ServiceImpl<CustomerMapper, Customer> implements CustomerService {
    ...
    public boolean add(CustomerDTO customerDTO) throws CommonException {
        ...
        customerQuery.eq("CUSTOMER", customer.getCustomer()).eq("SITE", customer.getSite());

        List<Customer> customerCount = customerMapper.selectList(customerQuery);
    ...
    public IPage<CustomerDTO> queryForList(CustomerDTO customerDTO) {
        ...
        customerDTO.setSite(UserUtils.getSite());
