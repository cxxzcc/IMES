...
public class DeviceTypeController {
    ...
    */
    ...
    public ResponseData<DeviceTypeVo> saveDeviceType(@RequestBody DeviceTypeVo deviceTypeVo ) throws CommonException, ParseException {
    ...
    public ResponseData<String> deleteDeviceType(String deviceType, String modifyDate ) throws CommonException, ParseException {
        if( StrUtil.isBlank( deviceType ) ){
            throw new CommonException( "设备类型不能为空", CommonExceptionDefinition.VERIFY_EXCEPTION );
        }
        ...
        deviceTypeService.deleteDeviceType( deviceType.trim(), DateUtil.parse( modifyDate, CustomCommonConstants.DATE_FORMAT_CONSTANTS ) );
