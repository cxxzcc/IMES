...
public class CommonCustomDataController {
    ...
    @GetMapping("/getSparePartCustomData")
    @ApiOperation(value="获取备件自定义数据")
    public ResponseData<List<CustomDataVo>> getSparePartCustomData() {
        return ResponseData.success( customDataService.selectCustomDataVoListByDataType( CustomDataTypeEnum.SPARE_PART.getDataType() ) );
    }
