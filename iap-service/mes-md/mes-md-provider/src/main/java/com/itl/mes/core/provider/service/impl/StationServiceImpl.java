...
public class StationServiceImpl extends ServiceImpl<StationMapper, Station> implements StationService {
    ...
    public StationVo getStationVoByStation(String station) throws CommonException {
        ...
        if(stationEntity.getOperationBo()!=null&&!stationEntity.getOperationBo().equals("")) {
            ...
            if(operation !=null) {
                Optional.ofNullable(operationService.getById(operation.getBo())).ifPresent(x -> {
    ...
    @Override
    public IPage<IapSysUserStationVO> findUserStations(UserStationQueryDTO userStationQueryDTO) {
