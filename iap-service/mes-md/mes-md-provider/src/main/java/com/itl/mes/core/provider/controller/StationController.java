...
public class StationController {
    ...
    public ResponseData<List<Station>> getStationBySite(@PathVariable String site) {
        return ResponseData.success(stationService.list(
                new QueryWrapper<Station>().lambda().eq(Station::getSite, site).eq(Station::getState,"1")));
    }
    ...
    public ResponseData<IPage<IapSysUserStationVO>> findUserStations(@RequestBody UserStationQueryDTO userStationQueryDTO) {
