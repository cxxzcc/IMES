 ...
 */
@Component
public class ItemLabelRuleHandle implements LabelRuleHandle {
    ...
    public Map<String, Object> handle(ItemForParamQueryDto queryDto) {
        ...
        //主字段
        Map<String, Object> map = BeanUtil.beanToMap(itemService.getById(elementBo));
    ...
    @Override
    public Map<String, Object> handleCustom(ItemForParamQueryDto queryDto) {
        String site = queryDto.getSite();
        Map<String, Object> ret = new HashMap<>();
        List<String> columns = queryDto.getColumns();
        String elementBo = queryDto.getElementBo();
        //自定义字段
        List<CustomDataAndValVo> customs = customDataValService.selectCustomDataAndValByBoAndDataType(site, elementBo, CustomDataTypeEnum.ITEM.getDataType());
