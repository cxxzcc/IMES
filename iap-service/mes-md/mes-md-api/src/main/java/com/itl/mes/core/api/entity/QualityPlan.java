...
public class QualityPlan extends Model<QualityPlan> {
    ...
    public QualityPlan(String bo, String site, String qualityPlan, String qualityPlanDesc, String version, String isCurrentVersion, String createUser, Date createDate, String modifyUser, Date modifyDate) {
        this.bo = bo;
        this.site = site;
        this.qualityPlan = qualityPlan;
        this.qualityPlanDesc = qualityPlanDesc;
