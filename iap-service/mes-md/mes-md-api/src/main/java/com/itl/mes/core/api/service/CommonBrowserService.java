...
public interface CommonBrowserService {
    ...
    IPage<Map<String, Object>> selectPageBomForTable(IPage<Map<String, Object>> page, @Param("params") Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPageStationForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
     ...
     * @return
     */
    List<MboMitemDTO> getLov(MboMitemDTO mboMitemDTO);
    /**
     * 模糊查询客户订单数据
     * customer
     * customerOrder
    ...
    IPage<Map<String, Object>> selectPageDataListForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPageDeviceForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPageShopOrderForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
     ...
     * @return
     */
    IPage<Map<String, Object>> selectPageShopOrderTwo(IPage<Map<String, Object>> page, Map<String, Object> params);
    IPage<Map<String, Object>> selectPageShopOrderTwoForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPageWarehouseForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    /**
     *模糊查询设备类型弹出框
     * deviceType
     * deviceTypeName
    ...
    IPage<Map<String, Object>> selectPageDeviceTypeForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPageTeamForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    /**
     * 模糊查询员工信息
     * EPMLOYEE_CODE
     * NAME
    ...
    IPage<Map<String, Object>> selectPageRouterForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
    ...
    IPage<Map<String, Object>> selectPagePackingForTable(IPage<Map<String, Object>> page, @Param("params") Map<String, Object> params);
    /**
     * 模糊查询载具类型信息
     * @param page
     * @param params
    ...
    IPage<Map<String, Object>> selectPageCarrierForTable(IPage<Map<String, Object>> page, @Param("params")Map<String, Object> params);

    //模糊查询用户表
    IPage<Map<String, Object>> selectPageUser(IPage<Map<String, Object>> page, Map<String, Object> params);
    IPage<Map<String, Object>> selectPageUserForTable(IPage<Map<String, Object>> page, Map<String, Object> params);
}
