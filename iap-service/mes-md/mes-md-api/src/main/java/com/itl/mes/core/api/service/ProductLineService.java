...
public interface ProductLineService extends IService<ProductLine> {
     ...
     * 查询产线相关数据
     *
     * @param productLineDto 产线查询实体
     * @return ProductLineVo
     * @throws CommonException 异常
     *//*
    IPage<ProductLineDto> getProductLineByProductLine(ProductLineDto productLineDto)throws CommonException;*/
    ...
    void saveByImport(List<ProductLineVo> list);
}
