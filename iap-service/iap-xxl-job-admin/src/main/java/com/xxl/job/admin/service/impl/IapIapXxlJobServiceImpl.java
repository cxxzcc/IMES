...
import com.xxl.job.admin.core.dto.IapXxlJobInfoSaveDto;
...
public class IapIapXxlJobServiceImpl implements IapXxlJobService {
    ...
    public Map<String, Object> pageList(int start, int length, int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author) {
        ...
        // page list
        List<IapXxlJobInfo> list = iapXxlJobInfoDao.pageList(start * length, length, jobGroup, triggerStatus, jobDesc, executorHandler, author);
     ...
     */
    @Override
    public ReturnT<String> add(IapXxlJobInfoSaveDto infoSaveDto) {
        IapXxlJobInfo jobInfo = new IapXxlJobInfo();
        BeanUtil.copyProperties(infoSaveDto, jobInfo);
        // valid
...
//        jobInfo.setId(id.intValue());
        if (databaseId.equals(CommonUtil.DATABASEID)) {
            IapXxlJobInfo maxJon = iapXxlJobInfoDao.selectOne(new QueryWrapper<IapXxlJobInfo>().eq("rownum",1).orderByDesc("id"));
            jobInfo.setId(maxJon.getId() + 1);
        }
     ...
     */
    @Override
    public ReturnT<String> update(IapXxlJobInfoSaveDto infoSaveDto) {
        ...
        iapXxlJobInfoDao.updateById(existsJobInfo);
    ...
    public ReturnT<String> remove(int id) {
        ...
        iapXxlJobInfoDao.remove(id);
        iapXxlJobLogDao.remove(id);
    ...
    public ReturnT<String> start(int id) {
        ...
        iapXxlJobInfoDao.updateById(iapXxlJobInfo);
        return ReturnT.SUCCESS;
    }
